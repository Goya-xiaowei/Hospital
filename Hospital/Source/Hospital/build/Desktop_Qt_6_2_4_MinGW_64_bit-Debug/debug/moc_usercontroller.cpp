...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_UserController_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_UserController_t qt_meta_stringdata_UserController = {
    {
QT_MOC_LITERAL(0, 14), // "UserController"
QT_MOC_LITERAL(15, 17), // "onSaveClickSiganl"
QT_MOC_LITERAL(33, 0) // ""

    },
    "UserController\0onSaveClickSiganl\0"
};
...
void UserController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onSaveClickSiganl(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserController::onSaveClickSiganl)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject UserController::staticMetaObject = { {
    ...
    qt_meta_stringdata_UserController.offsetsAndSize,
    qt_meta_data_UserController,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_UserController_t
, QtPrivate::TypeAndForceComplete<UserController, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void UserController::onSaveClickSiganl()
{
