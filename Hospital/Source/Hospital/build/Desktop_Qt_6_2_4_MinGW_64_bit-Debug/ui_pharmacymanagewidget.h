...
public:
    ...
    void setupUi(QWidget *PharmacyManageWidget)
    {
        if (PharmacyManageWidget->objectName().isEmpty())
            PharmacyManageWidget->setObjectName(QString::fromUtf8("PharmacyManageWidget"));
        PharmacyManageWidget->resize(531, 326);
        PharmacyManageWidget->setStyleSheet(QString::fromUtf8("QPushButton { background-color: rgba(0, 0, 0, 0); }"));
        ...
        layoutMedicationList->setObjectName(QString::fromUtf8("layoutMedicationList"));
        verticalSpacer_5 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        layoutMedicationList->addItem(verticalSpacer_5);

        btnMedicationList = new QPushButton(PharmacyManageWidget);
        btnMedicationList->setObjectName(QString::fromUtf8("btnMedicationList"));
        ...
        labelMedicationList->setObjectName(QString::fromUtf8("labelMedicationList"));
        ...
        layoutSendMedicine->setObjectName(QString::fromUtf8("layoutSendMedicine"));
        btnSendMedicine = new QPushButton(PharmacyManageWidget);
        btnSendMedicine->setObjectName(QString::fromUtf8("btnSendMedicine"));
        ...
        labelSendMedicine->setObjectName(QString::fromUtf8("labelSendMedicine"));
        ...
        pharmacyStackedWidget->setObjectName(QString::fromUtf8("pharmacyStackedWidget"));
        pharmacyStackedWidget->setStyleSheet(QString::fromUtf8("background-color: rgba(0, 0, 0, 0);"));
        page = new QWidget();
