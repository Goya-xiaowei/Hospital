...
public:
    ...
    void setupUi(QWidget *EmployManage)
    {
        ...
        pushButton = new QPushButton(EmployManage);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));

        horizontalLayout->addWidget(pushButton);

        pushButton_2 = new QPushButton(EmployManage);
    ...
    void retranslateUi(QWidget *EmployManage)
    {
        ...
        pushButton->setText(QCoreApplication::translate("EmployManage", "\344\277\256\346\224\271", nullptr));
        pushButton_2->setText(QCoreApplication::translate("EmployManage", "\345\210\240\351\231\244", nullptr));
    } // retranslateUi
