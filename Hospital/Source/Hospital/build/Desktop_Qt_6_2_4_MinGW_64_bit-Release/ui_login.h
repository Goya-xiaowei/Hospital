...
public:
    ...
    void setupUi(QWidget *Login)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/image/loginico.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"font: 10pt \"Candara\";"));
    ...
    {
        Login->setWindowTitle(QCoreApplication::translate("Login", "Hello Welcome To Login", nullptr));
