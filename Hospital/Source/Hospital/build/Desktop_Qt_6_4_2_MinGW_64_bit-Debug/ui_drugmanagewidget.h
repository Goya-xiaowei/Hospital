...
public:
    ...
    void setupUi(QWidget *DrugManageWidget)
    {
        if (DrugManageWidget->objectName().isEmpty())
            DrugManageWidget->setObjectName("DrugManageWidget");
        ...
        layoutDrugWarehouse->setObjectName("layoutDrugWarehouse");
        btnDrugWarehouse = new QPushButton(DrugManageWidget);
        btnDrugWarehouse->setObjectName("btnDrugWarehouse");
        ...
        labelDrugWarehouse->setObjectName("labelDrugWarehouse");
        ...
        layoutDrugReview->setObjectName("layoutDrugReview");
        btnDrugReview = new QPushButton(DrugManageWidget);
        btnDrugReview->setObjectName("btnDrugReview");
        ...
        labelDrugReview->setObjectName("labelDrugReview");
        ...
        layoutDrugOutWarehouse->setObjectName("layoutDrugOutWarehouse");
        btnDrugOutWarehouse = new QPushButton(DrugManageWidget);
        btnDrugOutWarehouse->setObjectName("btnDrugOutWarehouse");
        ...
        labelDrugOutWarehouse->setObjectName("labelDrugOutWarehouse");
        ...
        drugManageStacked->setObjectName("drugManageStacked");
        page = new QWidget();
