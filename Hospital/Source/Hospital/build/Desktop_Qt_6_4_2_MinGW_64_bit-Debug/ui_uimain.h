...
public:
    ...
    void setupUi(QWidget *UiMain)
    {
        ...
        UiMain->resize(1053, 600);
        UiMain->setMaximumSize(QSize(1080, 600));
        ...
        btnShowUser = new QLabel(widget);
        btnShowUser->setObjectName("btnShowUser");

        horizontalLayout_8->addWidget(btnShowUser);
        ...
        labelYearMonthDay->setObjectName("labelYearMonthDay");
        ...
        btnMinWidget->setObjectName("btnMinWidget");
        ...
        gridLayout_2->addWidget(btnMinWidget, 0, 0, 1, 1);

        btnMaxWidget = new QPushButton(widget);
        btnMaxWidget->setObjectName("btnMaxWidget");
        btnMaxWidget->setMinimumSize(QSize(30, 0));
        btnMaxWidget->setMaximumSize(QSize(30, 30));

        gridLayout_2->addWidget(btnMaxWidget, 0, 1, 1, 1);
        ...
        widgetManage->setObjectName("widgetManage");
...
"}"));
        ...
        btnDoctor->setObjectName("btnDoctor");
        ...
        btnOutpatientManage->setObjectName("btnOutpatientManage");
        ...
        btnPharmacyManage->setObjectName("btnPharmacyManage");
        ...
        btnDrugManage->setObjectName("btnDrugManage");
        ...
        btnFinancialManage->setObjectName("btnFinancialManage");
...
"}"));
    ...
    void retranslateUi(QWidget *UiMain)
    {
        ...
        btnShowUser->setText(QCoreApplication::translate("UiMain", "TextLabel", nullptr));
